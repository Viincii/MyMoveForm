...
public class LecteurExcel {
	...
	private String conversionInt(Cell cellule) {
	...
	private String conversion(Cell cellule) {
		CellType cT = cellule.getCellType();
		String res = "";
        switch(cT) {
	        case NUMERIC:
	...
	private String conversionDat(Cell cellule) {
		CellType cT = cellule.getCellType();
		String res = "";
        switch(cT) {
	        case NUMERIC:
	...
	private String conversionTel(Cell cellule) {
		CellType cT = cellule.getCellType();
		String res = "";
        switch(cT) {
	        case NUMERIC:
